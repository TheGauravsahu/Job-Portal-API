...
public class ExceptionController {
    ...
    public ResponseEntity<ErrorInfo> generalException(Exception exception) {
        ErrorInfo error = new ErrorInfo(HttpStatus.INTERNAL_SERVER_ERROR.value(), exception.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorInfo> jobPortalException(Exception exception) {
        ...
        ErrorInfo error = new ErrorInfo(HttpStatus.INTERNAL_SERVER_ERROR.value(),msg, LocalDateTime.now());
        return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<ErrorInfo> validatorException(Exception exception) {
        ...
        ErrorInfo error = new ErrorInfo(HttpStatus.BAD_REQUEST.value(), msg, LocalDateTime.now());
